...
export const User = ({id,name,last_name,email, avatar,onClickInvite, isInvited}) => (
  <li>
    <div>
    ...
    <img onClick={()=>onClickInvite(id)} className="action" src={`${isInvited ? minusIcon : plusIcon}`} alt="Action" />
  </li>
);
